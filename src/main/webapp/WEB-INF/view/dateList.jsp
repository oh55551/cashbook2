...
<body>
	...
	%>
		<tr>
			...
			<td><%= hasReceit ? "✅" : "❌" %></td>
			<td><a href="/cashbook2/cashOne.jsp?cash_no=<%=c.get("cash_no")%>">상세보기</a></td>
			<td><a href="/cashbook2/updateCashForm.jsp?cash_no=<%=c.get("cash_no")%>&cashDate=<%=cashDate%>">수정</td>
			<td><a href="/cashbook2/deleteCash.jsp?cashDate=<%=cashDate%>&cash_no=<%=c.get("cash_no")%>">삭제</a></td>
		</tr>
	<%
		}
	%>
	</table>
	<a href="/cashbook2/insertCashForm.jsp?cashDate=<%=cashDate %>" class="btn btn-sm btn-primary">내역 추가</a>
</body>
</html>